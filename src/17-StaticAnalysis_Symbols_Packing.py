...
print("Deep Learning")
print("==========================================================================")
x_test_new = np.reshape(x_test_benign,(x_test_benign.shape[0],x_test_benign.shape[1]))
# create model
...
print("Deep Learning")
print("==========================================================================")
x_test_new = np.reshape(x_test_malware,(x_test_malware.shape[0],x_test_malware.shape[1]))
# create model
json_file = open('../model/Static/SymbolsBaselineDNN.json','r')
loaded_model_json = json_file.read()
json_file.close()
