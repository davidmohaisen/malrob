...
def main():
    ...
    _, _, _, FilesMalwareTest = pickle.load(f)
    ...
    for mal in malwareList:
        newMalPath = "../data/malData/packedMalware/"
        if not os.path.isdir(newMalPath):
            os.mkdir(newMalPath)
    ...
    for mal in malwareList:
        newMalPath = "../data/malData/strippedMalware/"
        if not os.path.isdir(newMalPath):
            os.mkdir(newMalPath)
        os.system("cp "+malPath+mal+" "+newMalPath+mal)
    ...
    for mal in malwareList:
        newMalPath = "../data/malData/packedMalware-Best/"
        if not os.path.isdir(newMalPath):
            os.mkdir(newMalPath)
        os.system("cp "+malPath+mal+" "+newMalPath+mal)
        degree = "--best "
