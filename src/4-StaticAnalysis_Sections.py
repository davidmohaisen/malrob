...
pathBenign = "../linuxBenignStaticAnalysisResults/sections/"
pathMalware = "../malwareStaticAnalysisResults/sections/"
...
f = open("../Pickles/Static/SectionsF","wb")
...
f = open("../Pickles/Static/SectionsTrainDataP1", "wb")
pickle.dump([x_train[:int(len(x_train)/2)],y_train[:int(len(x_train)/2)]],f)
f = open("../Pickles/Static/SectionsTrainDataP2", "wb")
pickle.dump([x_train[int(len(x_train)/2):],y_train[int(len(x_train)/2):]],f)
...
f = open("../Pickles/Static/SectionsTestData", "wb")
...
f = open("../model/Static/SectionsBaselineLR","wb")
pickle.dump(clf,f)
...
f = open("../model/Static/SectionsBaselineRF","wb")
pickle.dump(clf,f)
print("==========================================================================")
...
with open("../model/Static/SectionsBaselineDNN.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../model/Static/SectionsBaselineDNN.h5")
...
# print('Test accuracy:', scores[1])
# model_json = model.to_json()
# with open("../model/Static/SectionsBaselineCNN.json", "w") as json_file:
#     json_file.write(model_json)
# # serialize weights to HDF5
# model.save_weights("../model/Static/SectionsBaselineCNN.h5")
# print("Saved model to disk")
