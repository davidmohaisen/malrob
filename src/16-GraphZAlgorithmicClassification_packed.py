...
print("LR")
print("==========================================================================")
x_test_new_ = np.reshape(x_test_benign,(x_test_benign.shape[0],x_test_benign.shape[1]))
...
print("LR")
print("==========================================================================")
x_test_new_ = np.reshape(x_test_malware,(x_test_malware.shape[0],x_test_malware.shape[1]))
f = open("../model/Graph/AlgorithmicBaselineLR","rb")
clf = pickle.load(f)
...
for pathEval in insideFoldersBenign:
    ...
    f = open(path+pathEval+"DataAlgorithmic","rb")
    ...
    print("LR")
    print("==========================================================================")
    x_test_new_ = np.reshape(x_test,(x_test.shape[0],x_test.shape[1]))
    f = open("../model/Graph/AlgorithmicBaselineLR","rb")
    clf = pickle.load(f)
