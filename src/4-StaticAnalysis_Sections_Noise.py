...
for pert in np.arange(0.00,1.01,0.01):
    ...
    f = open("../model/Static/SectionsBaselineLR","rb")
    clf = pickle.load(f)
    ...
    print("RF")
    print("==========================================================================")
    f = open("../model/Static/SectionsBaselineRF","rb")
    clf = pickle.load(f)
    score = clf.score(x_test_new, y_test)
    ...
    json_file = open('../model/Static/SectionsBaselineDNN.json','r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = model_from_json(loaded_model_json)
    model.load_weights("../model/Static/SectionsBaselineDNN.h5")
...
f = open("/media/ahmed/HDD/ICDCS2021/Pickles/Noise/Sections","wb")
