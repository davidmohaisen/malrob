...
pathBenign = "../linuxBenignStaticAnalysisResults/segments/"
pathMalware = "../malwareStaticAnalysisResults/segments/"
...
f = open("../Pickles/Static/SegmentsF","wb")
...
f = open("../Pickles/Static/SegmentsTrainDataP1", "wb")
pickle.dump([x_train[:int(len(x_train)/2)],y_train[:int(len(x_train)/2)]],f)
f = open("../Pickles/Static/SegmentsTrainDataP2", "wb")
pickle.dump([x_train[int(len(x_train)/2):],y_train[int(len(x_train)/2):]],f)
...
f = open("../Pickles/Static/SegmentsTestData", "wb")
...
f = open("../model/Static/SegmentsBaselineLR","wb")
pickle.dump(clf,f)
...
f = open("../model/Static/SegmentsBaselineRF","wb")
pickle.dump(clf,f)
print("==========================================================================")
...
with open("../model/Static/SegmentsBaselineDNN.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../model/Static/SegmentsBaselineDNN.h5")
...
# print('Test accuracy:', scores[1])
# model_json = model.to_json()
# with open("../model/Static/SegmentsBaselineCNN.json", "w") as json_file:
#     json_file.write(model_json)
# # serialize weights to HDF5
# model.save_weights("../model/Static/SegmentsBaselineCNN.h5")
# print("Saved model to disk")
