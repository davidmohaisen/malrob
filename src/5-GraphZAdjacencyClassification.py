...
# f = open("../model/Graph/AdjacencyBaselineLR","wb")
# pickle.dump(clf,f)
#
#
# print("==========================================================================")
...
# f = open("../model/Graph/AdjacencyBaselineRF","wb")
# pickle.dump(clf,f)
# print("==========================================================================")
...
# create model
model = Sequential()
model.add(keras.layers.Conv2D(filter,(3,3),padding="same",activation="relu",input_shape=(x_train.shape[1:])))
model.add(keras.layers.Conv2D(filter,(3,3),padding="valid",activation="relu"))
model.add(keras.layers.MaxPooling2D())
model.add(keras.layers.Dropout(0.25))
model.add(keras.layers.Conv2D(filter*2,(3,3),padding="same",activation="relu"))
model.add(keras.layers.Conv2D(filter*2,(3,3),padding="valid",activation="relu"))
model.add(keras.layers.MaxPooling2D())
# model.add(keras.layers.Dropout(0.25))
...
print('Test accuracy:', scores[1])
model_json = model.to_json()
with open("../model/Graph/AdjacencyBaselineCNN.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../model/Graph/AdjacencyBaselineCNN.h5")
print("Saved model to disk")
